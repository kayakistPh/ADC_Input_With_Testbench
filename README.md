...
![Datasheet timing diagram](./documentation/ImageSource/DataFormat.PNG)

Image taken from Ad4007 datasheet to show timing.

The timing is driven by an FSM:

![ADC FSM](./documentation/ImageSource/ADCfsm.png)
...
![Latched data out](./documentation/ImageSource/DataRead.PNG)

This is driven by the FSM.

![Data out FSM](./documentation/ImageSource/DataOutFSM.png)
...
![Latched data out](./documentation/ImageSource/DataCorrect.PNG)
